...
const NeuralNetworkAnimated = () => {
  return (
    <div className="flex justify-center items-center">
      <svg width="500" height="220" viewBox="0 0 500 220" className="drop-shadow-lg">
        <defs>
        ...
        {/* Layer labels */}
        <text x="50" y="210" textAnchor="middle" className="text-sm font-medium fill-gray-600">Input</text>
        <text x="150" y="210" textAnchor="middle" className="text-sm font-medium fill-gray-600">Hidden 1</text>
        <text x="270" y="210" textAnchor="middle" className="text-sm font-medium fill-gray-600">Hidden 2</text>
        <text x="370" y="210" textAnchor="middle" className="text-sm font-medium fill-gray-600">Hidden 3</text>
        <text x="470" y="210" textAnchor="middle" className="text-sm font-medium fill-gray-600">Output</text>
      </svg>
    </div>
  );
};
